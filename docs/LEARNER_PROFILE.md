...
- Second-year Computer Science and Technology student at Fudan University.
- Goal: find a first internship or join a research group in about three months.

## Current strengths

- Notices system-level omissions such as memory, context management, and bounded
  execution instead of accepting an "agent" label at face value.
...
1. Keep the core loop mentally small.
2. Learn each protection layer by the failure it prevents.
